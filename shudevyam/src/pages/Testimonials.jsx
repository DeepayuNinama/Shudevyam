  ...
  return (
    <div className='w-full mx-auto pt-32 sm:pt-0'>
      ...
      <section className='relative mt-16 sm:mt-24 lg:mt-28 mx-0 sm:mx-10 lg:mx-20'>
        ...
        {/* CONTENT CONTAINER */}
        <div className='bg-red-950/40 p-6 sm:p-10 lg:p-16 h-[86vh] sm:h-auto overflow-visible sm:overflow-hidden relative pb-8 sm:pb-0'>
            ...
            <AnimatePresence mode="wait">
              <motion.div 
                ...
                className='flex flex-col lg:flex-row justify-between relative z-0 gap-8 lg:gap-10 mb-8 sm:mb-0'
              >
            ...
            <div className='absolute bottom-4 left-1/2 -translate-x-1/2 w-full flex justify-center gap-4 sm:gap-5 z-10 sm:static sm:translate-x-0 sm:mt-6 lg:-mt-16 sm:justify-end'>
                <button 
                  onClick={handlePrev}
